                                    ...
                                    <div className="row">
                                        {
                                            jsonData.map((person, index) => (
                                                <>
                                                    <div className="col-xl-3 col-xxl-3 col-lg-6 col-md-4 col-sm-6 user-info" onClick={() => changeUserInfo(person)}>
                                                        <div>
                                                            <img src={person.img} alt="team 1" />
                                                            <span className="d-block fw-500 mt-3">{person.name}</span>
                                                            <small className="d-block mb-2">{person.position}</small>
                                                            <ul className="p-0">
                                                                <li className="d-flex">
